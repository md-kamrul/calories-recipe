    ...
    return (
        <div className="navbar flex flex-col md:flex-row">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-xl text-[#150B2B]">Recipe Calories</a>
            </div>
            ...
            <div className="navbar-end text-[#150B2BB3] flex flex-col md:flex-row gap-3">
                ...
                <CgProfile className="w-12 h-12 p-3 bg-[#0BE58A] rounded-full text-[#150B2BB3] cursor-pointer"></CgProfile>
            </div>
        </div>
    );
};
